...
//        self::$attrs = ['products' => json_encode($products)];
    ...
    public function getPriceAttribute()
    {
        ...
        if (isset($configure['fee_compute_mode']) && $configure['fee_compute_mode'] == 'by_number') {
        ...
        if(isset($products)){
            ...
            foreach ($products as $product) {
                ...
                if($goods_weight){
                    ...
                    $amount += Goods::get_final_price($product['goods_id'], $product['num'],true,$product['property']) * $product['num'];
                    $number += $product['num'];
                }
