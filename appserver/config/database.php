...
return [
    ...
    */
    ...
    'default' => env('DB_CONNECTION', 'shop'),
    ...
    */
    ...
    'connections' => [
        'shop' => [
            'driver'    => 'mysql',
            'host'      => env('SHOP_DB_HOST', 'localhost'),
            'port'      => env('SHOP_DB_PORT', 3306),
            'database'  => env('SHOP_DB_DATABASE', 'forge'),
            'username'  => env('SHOP_DB_USERNAME', 'forge'),
            'password'  => env('SHOP_DB_PASSWORD', ''),
            'charset'   => 'utf8',
            'collation' => 'utf8_general_ci',
            'prefix'    => env('SHOP_DB_PREFIX', ''),
