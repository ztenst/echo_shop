...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','小米官网','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','小米官网——小米手机、红米手机、小米电视官方正品专卖网站','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','小米官方网站包含小米手机系列小米NOTE、小米4，红米手机系列红米Note、红米2/2A还有小米电视40/49/55英寸、手环、移动电源、运动相机,小米智能家居系列路由器、空气净化器、体重秤、插线板等小米商城均有售。','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','小米,小米手机,小米官网,红米手机,小米商城,小米电视','1');");
...
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','重庆市杨家坪','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','111111111,22222222,33333333','1');");
E_D("replace into `ecs_shop_config` values('110','1','ww','text','','','44444444,55555555,6666666','1');");
...
E_D("replace into `ecs_shop_config` values('114','1','service_email','text','','','631366604@qq.com','1');");
E_D("replace into `ecs_shop_config` values('115','1','service_phone','text','','','400-023-3005','1');");
E_D("replace into `ecs_shop_config` values('116','1','shop_closed','select','0,1','','0','1');");
E_D("replace into `ecs_shop_config` values('117','1','close_comment','textarea','','','用户中心公告！','1');");
E_D("replace into `ecs_shop_config` values('118','1','shop_logo','file','','../themes/{\$template}/images/','../themes/xiaomi/images/logo.gif','1');");
...
E_D("replace into `ecs_shop_config` values('202','2','icp_number','text','','','©<a href=''#''>mi.com</a> 京ICP证110507号 京ICP备10046444号 京公网安备1101080212535号 <a href=''#''>京网文[2014]0059-0009号</a>','1');");
...
E_D("replace into `ecs_shop_config` values('229','2','default_storage','text','','','10000','1');");
...
E_D("replace into `ecs_shop_config` values('239','2','certificate_id','hidden','','','','1');");
E_D("replace into `ecs_shop_config` values('240','2','token','hidden','','','','1');");
E_D("replace into `ecs_shop_config` values('241','2','certi','hidden','','','http://localhost/api/api.php','1');");
...
E_D("replace into `ecs_shop_config` values('303','3','currency_format','text','','','%s<em>元</em>','1');");
...
E_D("replace into `ecs_shop_config` values('306','3','image_width','text','','','350','1');");
E_D("replace into `ecs_shop_config` values('307','3','image_height','text','','','350','1');");
...
E_D("replace into `ecs_shop_config` values('314','3','comments_number','text','','','10','1');");
E_D("replace into `ecs_shop_config` values('315','3','bought_goods','text','','','3','1');");
E_D("replace into `ecs_shop_config` values('316','3','article_number','text','','','4','1');");
E_D("replace into `ecs_shop_config` values('317','3','goods_name_length','text','','','30','1');");
...
E_D("replace into `ecs_shop_config` values('330','3','search_keywords','text','','','小米手环,耳机,插线板','0');");
...
E_D("replace into `ecs_shop_config` values('418','4','invoice_content','textarea','','','办公用品\r\n食品\r\n礼品\r\n服装','1');");
...
E_D("replace into `ecs_shop_config` values('422','4','invoice_type','manual','','','a:2:{s:4:\"type\";a:3:{i:0;s:1:\"1\";i:1;s:1:\"2\";i:2;s:1:\"3\";}s:4:\"rate\";a:3:{i:0;d:1;i:1;d:1.5;i:2;d:0;}}','1');");
...
E_D("replace into `ecs_shop_config` values('503','5','smtp_user','text','','','ecmoban1@163.com','1');");
E_D("replace into `ecs_shop_config` values('504','5','smtp_pass','password','','','admin123','1');");
E_D("replace into `ecs_shop_config` values('505','5','smtp_mail','text','','','ecmoban1@163.com','1');");
E_D("replace into `ecs_shop_config` values('506','5','mail_charset','select','UTF8,GB2312,BIG5','','GB2312','1');");
...
E_D("replace into `ecs_shop_config` values('603','6','hash_code','hidden','','','499d1f1cbd0e575c3b6f1cfcca61f9c3','1');");
E_D("replace into `ecs_shop_config` values('604','6','template','hidden','','','xiaomi','1');");
E_D("replace into `ecs_shop_config` values('605','6','install_date','hidden','','','1398244332','1');");
...
E_D("replace into `ecs_shop_config` values('910','8','sms_ecmoban_user','text','','','','0');");
E_D("replace into `ecs_shop_config` values('911','8','sms_ecmoban_password','password','','','','0');");
E_D("replace into `ecs_shop_config` values('912','8','sms_signin','select','1,0','','0','1');");
