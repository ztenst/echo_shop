...
E_D("replace into `ecs_touch_nav` values('6',NULL,'0','论坛','1','0','0','http://bbs.ecmoban.com','icon_indexn_06.png','middle');");
E_D("replace into `ecs_touch_nav` values('7',NULL,'0','客户端','1','0','0','http://www.ecmoban.com/app/ecmoban.apk','icon_indexn_07.png','middle');");
E_D("replace into `ecs_touch_nav` values('8',NULL,'0','电脑版','1','0','0','../','icon_indexn_08.png','middle');");
