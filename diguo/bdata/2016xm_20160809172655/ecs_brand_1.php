...
E_D("replace into `ecs_brand` values('77','科颜氏','','','','50','1','');");
E_D("replace into `ecs_brand` values('78','小青猪','','','','50','1','');");
E_D("replace into `ecs_brand` values('79','希芸','','','','50','1','');");
E_D("replace into `ecs_brand` values('80','It''s Skin','','','','50','1','');");
E_D("replace into `ecs_brand` values('81','姬芮','','','','50','1','');");
E_D("replace into `ecs_brand` values('82','婵真','','','','50','1','');");
E_D("replace into `ecs_brand` values('83','美丽工匠','','','','50','1','');");
E_D("replace into `ecs_brand` values('84','亦博','','','','50','1','');");
E_D("replace into `ecs_brand` values('85','雅诗兰黛','','','','50','1','');");
E_D("replace into `ecs_brand` values('86','CANMAKE','','','','50','1','');");
E_D("replace into `ecs_brand` values('87','Solone','','','','50','1','');");
E_D("replace into `ecs_brand` values('88','StyleNanda','','','','50','1','');");
E_D("replace into `ecs_brand` values('89','美国箭牌','','','','50','1','');");
E_D("replace into `ecs_brand` values('90','英国AA','','','','50','1','');");
E_D("replace into `ecs_brand` values('91','资生堂','','','','50','1','');");
E_D("replace into `ecs_brand` values('92','罗瑞塔','','','','50','1','');");
E_D("replace into `ecs_brand` values('93','绿丽','','','','50','1','');");
E_D("replace into `ecs_brand` values('94','安若蔓','','','','50','1','');");
E_D("replace into `ecs_brand` values('95','玛姬儿','','','','50','1','');");
E_D("replace into `ecs_brand` values('96','蜜丝佛陀','','','','50','1','');");
E_D("replace into `ecs_brand` values('97','蝶翠诗','','','','50','1','');");
