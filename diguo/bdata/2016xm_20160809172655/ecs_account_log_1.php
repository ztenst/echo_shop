...
E_D("replace into `ecs_account_log` values('61','2','0.00','0.00','99','99','1441823955','订单 2015090922397 赠送的积分','99');");
E_D("replace into `ecs_account_log` values('62','2','0.00','0.00','299','299','1441833387','订单 2015090966609 赠送的积分','99');");
E_D("replace into `ecs_account_log` values('63','16','0.00','0.00','327','327','1441906074','订单 2015083129579 赠送的积分','99');");
E_D("replace into `ecs_account_log` values('64','16','0.00','0.00','258','258','1441906236','订单 2015082830546 赠送的积分','99');");
E_D("replace into `ecs_account_log` values('65','16','0.00','0.00','1467','1467','1441906327','订单 2015082675900 赠送的积分','99');");
