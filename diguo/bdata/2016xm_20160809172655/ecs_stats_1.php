...
E_D("replace into `ecs_stats` values('1441904930','127.0.0.1','6','Safari 537.36','Windows NT','zh-CN,zh','LAN','http://localhost','/testxiaomi/admin/index.php?act=top','/testxiaomi/index.php');");
E_D("replace into `ecs_stats` values('1446663320','222.182.199.85','6','Safari 537.36','Windows NT','zh-CN,zh','','','','/mima.php');");
E_D("replace into `ecs_stats` values('1446663475','222.182.199.85','1','FireFox 40.0','Windows NT','zh-CN,zh','','','','/mobile/index.php');");
E_D("replace into `ecs_stats` values('1446663660','222.182.199.85','7','Safari 537.36','Windows NT','zh-CN,zh','','','','/mobile/index.php');");
E_D("replace into `ecs_stats` values('1446663818','222.182.199.85','8','Safari 537.36','Windows NT','zh-CN,zh','','','','/mobile/index.php');");
E_D("replace into `ecs_stats` values('1446664231','222.182.199.85','9','Safari 537.36','Windows NT','zh-CN,zh','','','','/mobile88/index.php');");
