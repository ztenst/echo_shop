...
E_D("replace into `ecs_touch_shipping` values('1','post_express','邮政快递包裹','邮政快递包裹的描述内容。','2%','0','1','','','','0','0');");
...
E_D("replace into `ecs_touch_shipping` values('3','city_express','城际快递','配送的运费是固定的','0','1','1','','/images/receipt/20141028hbvggu.png','','0','0');");
...
E_D("replace into `ecs_touch_shipping` values('8','cac','上门取货','买家自己到商家指定地点取货','0','1','1','','/images/receipt/20141028vqkgeo.png','','2','0');");
