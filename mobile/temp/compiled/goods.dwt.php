...
?>
          ...
          <li><img src="themesmobile/68ecshopcom_mobile/images/hui.png">购买<?php echo $this->_var['price_list']['number']; ?>件&nbsp;优惠价：<?php echo $this->_var['price_list']['format_price']; ?></li> 
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          </ul>
     <?php endif; ?>
      ...
      <li><img src="themesmobile/68ecshopcom_mobile/images/hui.png"><?php echo $this->_var['lang']['goods_integral']; ?><?php echo $this->_var['goods']['integral']; ?><?php echo $this->_var['points_name']; ?></li> 
      <?php endif; ?>
         <?php if ($this->_var['goods']['give_integral'] > 0): ?>
         <li><img src="themesmobile/68ecshopcom_mobile/images/hui.png"><?php echo $this->_var['lang']['goods_give_integral']; ?> <?php echo $this->_var['goods']['give_integral']; ?><?php echo $this->_var['points_name']; ?></li> 
        <?php endif; ?>
           <?php if ($this->_var['goods']['bonus_money']): ?>
   <li><img src="themesmobile/68ecshopcom_mobile/images/hui.png"><?php echo $this->_var['lang']['goods_bonus']; ?><?php echo $this->_var['goods']['bonus_money']; ?></li>
      </li>
      <?php endif; ?>
...
<div class="ui-sx bian1"> 
<div class="subNavBox" > 
<div class="subNav" style=" border:0;"><a href="pocking.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" style=" border:0px;"><strong>自提点</strong></a></div>
</div>
</div> 
...
<div class="top_info">
<dl>
<dt><a href="supplier.php?suppId=<?php echo $this->_var['suppid']; ?>"><div style="background-image:url(./../<?php echo $this->_var['shoplogo']; ?>)"></div></a></dt>
<dd><strong>卖家: <a href="supplier.php?suppId=<?php echo $this->_var['suppid']; ?>" style="color:#333; font-size:18px;"><?php echo $this->_var['shopname']; ?></a></strong><em><?php echo $this->_var['userrank']; ?></em></dd>
</dl>
<ul>
<li><span>宝贝描述</span><strong>:<?php if ($this->_var['c_rank'] > 0): ?><?php echo $this->_var['c_rank']; ?><?php else: ?>5.0<?php endif; ?></strong><em><?php if ($this->_var['c_rank'] > 0): ?><?php if ($this->_var['c_rank'] <= 2): ?>低<?php elseif ($this->_var['c_rank'] > 2 && $this->_var['c_rank'] <= 4): ?>中<?php else: ?>高<?php endif; ?><?php else: ?>高<?php endif; ?></em></li>
<li><span>卖家服务</span><strong>:<?php if ($this->_var['serv_rank'] > 0): ?><?php echo $this->_var['serv_rank']; ?><?php else: ?>5.0<?php endif; ?></strong><em><?php if ($this->_var['serv_rank'] > 0): ?><?php if ($this->_var['serv_rank'] <= 2): ?>低<?php elseif ($this->_var['serv_rank'] > 2 && $this->_var['serv_rank'] <= 4): ?>中<?php else: ?>高<?php endif; ?><?php else: ?>高<?php endif; ?></em></li>
<li><span>物流服务</span><strong>:<?php if ($this->_var['shipp_rank'] > 0): ?><?php echo $this->_var['shipp_rank']; ?><?php else: ?>5.0<?php endif; ?></strong><em><?php if ($this->_var['shipp_rank'] > 0): ?><?php if ($this->_var['shipp_rank'] <= 2): ?>低<?php elseif ($this->_var['shipp_rank'] > 2 && $this->_var['shipp_rank'] <= 4): ?>中<?php else: ?>高<?php endif; ?><?php else: ?>高<?php endif; ?></em></li>
</ul>
</div>
<div class="s_dianpu">
<span><a href="tel:<?php echo $this->_var['servicephone']; ?>" style=" margin-left:7%;"><em class="bg1"></em>联系客服</a></span>
...
?>
         ...
         <?php if ($this->_foreach['pa_list_goods']['iteration'] == 3): ?>
          ...
          <dd><?php echo $this->_var['pa_goods']['rank_price_zk_format']; ?></dd>
           ...
           <div class="jia"><img src="themesmobile/68ecshopcom_mobile/images/jia.png" class="B_eee" ></div>
           <?php endif; ?>
          <?php endif; ?>
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
<?php endif; ?>
...
<section class="index_floor is_scroll">
    <h2>
      ...
      <div class="bd">
        <ul>
           <?php $_from = $this->_var['fittings']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_04682600_1487143005');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_04682600_1487143005']):
?>
          <li>
            <a href="<?php echo $this->_var['goods_0_04682600_1487143005']['url']; ?>">
              <div class="products_kuang">
                <img src="<?php echo $this->_var['goods_0_04682600_1487143005']['goods_thumb']; ?>"></div>
              <div class="goods_name"><?php echo htmlspecialchars($this->_var['goods_0_04682600_1487143005']['short_name']); ?></div>
              <div class="price" >
              <p href="<?php echo $this->_var['goods_0_04682600_1487143005']['url']; ?>"><?php echo $this->_var['goods_0_04682600_1487143005']['fittings_price']; ?> </p>
                 <a href="javascript:addToCart(<?php echo $this->_var['goods_0_04682600_1487143005']['goods_id']; ?>);" class="car">
                    <img src="themesmobile/68ecshopcom_mobile/images/xin/cutp.png">
                </a>
              </div>
            </a>
