...
.picScroll .bd1 li{width:50%; float:left; font-size:14px; text-align:center;}
.picScroll .bd1 li a{-webkit-tap-highlight-color:rgba(0, 0, 0, 0); /* 取消链接高亮 */}
.picScroll .bd1 li img{width:150px; height:150px;}
</style>
...
?>
				...
				<font style="font-size:8px">市场价</font><del style="font-size: .675rem;"><?php echo $this->_var['goods']['market_price']; ?></del>
