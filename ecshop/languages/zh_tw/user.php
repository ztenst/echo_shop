...
$_LANG['username_inexistent'] = '用戶名 %s 不存在';
...
$_LANG['phone_number_reg_check_fail'] = '手機號輸入錯誤或未註冊';
...
　　１、將本站提供給您的推薦代碼，發送到論壇、博客上。
　　２、訪問者點擊鏈接，訪問網店。
　　３、在訪問者點擊鏈接的 <b>%d%s</b> 內，若該訪問者在本站註冊，即認定該用戶是您推薦的，您將獲得等級積分 <b>%d</b> 的獎勵 (當您的等級積分超過 <b>%d</b> 時，不再獲得獎勵)。
　　４、該用戶今後在本站的一切消費，您均能獲得一定比例的提成。目前實行的提成總額為訂單金額的 <b>%s</b> 、積分的 <b>%s</b> ，分配給您、推薦您的人等，具體分配規則請參閱 <b><a href="#myrecommend">我推薦的會員</a></b>。
　　５、提成由管理員人工審核發放，請您耐心等待。
　　６、您可以通過分成明細來查看您的介紹、分成情況。';
$_LANG['affiliate_intro'][1] = '　　本網店為鼓勵推薦新用戶註冊，現開展<b>推薦訂單分成</b>活動，活動流程如下：

　　１、在瀏覽商品時，點擊推薦此商品，獲得推薦代碼，將其發送到論壇、博客上。
　　２、訪問者點擊鏈接，訪問網店。
　　３、在訪問者點擊鏈接的 <b>%d%s</b> 內，若該訪問者在本站有訂單，即認定該訂單是您推薦的。
