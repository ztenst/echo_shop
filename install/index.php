...
<div style="background: url(login_dl.jpg) no-repeat;background-size:100% 100%;width: 100%;height: 100%;float: left;position:fixed;">
    <h1 style="text-align: center;padding: 80px 0 30px 0;border: ">乐帮电商</h1>
    <h2 style="text-align: center;">为站长提供最好的建站资源和素材</h2>
    <form action="" method="post" style="width: 300px;height: auto;margin: 60px auto 0 auto;padding: 40px;border: 2px solid #B6B6B6;border-radius: 5px;background-color: #F5F5F5" name="install" onSubmit="return check();">
        ...
        <button type="submit" name="install" style="font-size: 16px;float: right;cursor: pointer;">开始安装</button>
    </form>
    <div style="width: 100%;line-height: 35px;font-size: 12px;color: #585858;text-align: center;position:fixed;bottom:0;"><a href="http://www.xtlebang.com" target="_blank" style="text-decoration: none;color: #585858;">Copyright © 2015 - 2016 鸿宇 版权所有 盗版必究 本程序仅供学习交流使用，请勿用于商业用途。</a></div>
</div>
