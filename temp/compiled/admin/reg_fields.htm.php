...
?>
  <tr>
    ...
    <td align="right"><a href="?act=edit&id=<?php echo $this->_var['field']['id']; ?>"><?php echo $this->_var['lang']['edit']; ?></a><?php if ($this->_var['field']['type'] == 0): ?> | <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['field']['id']; ?>, '<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"><?php echo $this->_var['lang']['remove']; ?></a><?php endif; ?></td>
  </tr>
