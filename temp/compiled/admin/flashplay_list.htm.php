...
?>
    ...
    <td align="left"><a href="<?php echo $this->_var['item']['url']; ?>" target="_blank"><?php echo $this->_var['item']['url']; ?></a></td>
      ...
      <td align="left"><?php echo $this->_var['item']['sort']; ?></td>
         <!-- 周欢改 start-->
      <td align="left"><?php if ($this->_var['item']['width_screen'] == 0): ?>宽<?php else: ?>窄<?php endif; ?></td>
      <!-- 周欢改 end-->
    <td align="center">
        <a href="flashplay.php?act=edit&id=<?php echo $this->_var['key']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" width="21" height="21" border="0" /></a>
        <a href="flashplay.php?act=del&id=<?php echo $this->_var['key']; ?>" onclick="return check_del();" title="<?php echo $this->_var['lang']['trash_img']; ?>"><img src="images/icon_drop.gif" width="21" height="21" border="0" /></a>
      </td>
    </tr>
