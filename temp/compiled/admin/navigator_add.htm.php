...
<tr>
    <td><a href="javascript:showNotice('notice_url');" title="<?php echo $this->_var['lang']['notice_url']; ?>"><img src="images/notice.gif" width="21" height="21" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"><?php echo $this->_var['lang']['item_url']; ?></a></td> <td><input type="text" name="item_url" value="<?php echo $this->_var['rt']['item_url']; ?>" id="item_url" size="40" onKeyPress="javascript:key();" /></td>
</tr>
  <tr>
    <td></td>
    <td>
