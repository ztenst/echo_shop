...
#admininfo-div span.left{float:left;height:68px; line-height:58px;background:url(images/ui_04.png) no-repeat 10px 12px; text-indent:30px; color:#d2d4d1;}
#admininfo-div span.right{float:left;height:68px; line-height:58px;background:url(images/ui_17.png) no-repeat 5px 13px; text-indent:20px; color:#e9e9e9;}
...
#submenu-div li {
float: right;
 width:77px;  text-align:center; height:68px; background:url(images/top_line.gif) no-repeat left top;
}
#submenu-div li a{
display:block; background:url(images/top_header.png) no-repeat left top; padding-top:30px; height:38px; line-height:38px;
}
...
#submenu-div li.show_11 a:hover{
...
#menu-div li.midd_21 {
	background:url(images/midd.png) no-repeat;background-position:10px 13px; border-left:4px #0e94d1 solid; text-indent:12px;

}
#menu-div li.midd_22 {
		background:url(images/midd.png) no-repeat;background-position:0px -18px;

}
#menu-div li.midd_23 {
	background:url(images/midd.png) no-repeat;background-position:0px -54px;

}
#menu-div li.midd_1 {
	background:url(images/midd.png) no-repeat;background-position:0px -93px;
}
#menu-div li.midd_2 {
	background:url(images/midd.png) no-repeat;background-position:0px -133px;
}
#menu-div li.midd_3 {
	background:url(images/midd.png) no-repeat;background-position:0px -172px;
}
#menu-div li.midd_4 {
	background:url(images/midd.png) no-repeat;background-position:0px -208px;
}
#menu-div li.midd_5 {
	background:url(images/midd.png) no-repeat;background-position:0px -245px;
}
#menu-div li#xinjian_div {
	background:url(images/midd.png) no-repeat;background-position:0px -274px;
}
...
width:196px; height:45px; float:left; line-height:45px; color:#ffffff; font-size:14px; font-weight:bold; text-indent:18px;
}
...
<li class="show_5"><a href="message.php?act=list" target="main_frame"><?php echo $this->_var['lang']['view_message']; ?></a></li>
<li class="show_2"><a href="#"  onclick="ShowToDoList()"><?php echo $this->_var['lang']['todolist']; ?></a></li>
<li class="show_11"><a href="index.php?act=clear_cache_mobile" class="qinghc" target="main_frame">手机缓存</a></li>
<li class="show_4"> <a href="index.php?act=clear_cache" class="qinghc" target="main_frame"><?php echo $this->_var['lang']['clear_cache']; ?></a></li>
<li class="show_4"><a href="index.php?act=clear_html"  target="main_frame">更新全部静态</a></li>
<li class="show_4"><a href="index.php?act=clear_index"  target="main_frame">更新首页静态</a></li>
...
<!--<li id="xinjian_div">
<a href="javascript:void(0)" onmouseover="show_popup()" style="display:block;"><?php echo $this->_var['lang']['button_new']; ?></a>
</li>
...
-->    <li class="midd_22"><a href="index.php?act=main" target="main_frame">起始页</a></li>
    ...
    <li class="midd_1"><a href="goods.php?act=list" target="main_frame">商品列表<span><em></em><?php echo $this->_var['datainfo']['goods']; ?></span></a></li>
    <li class="midd_2"><a href="order.php?act=list" target="main_frame">订单列表<span><em></em><?php echo $this->_var['datainfo']['order']; ?></span></a></li>
    <li class="midd_3"><a href="comment_manage.php?act=list" target="main_frame">用户评论<span><em></em><?php echo $this->_var['datainfo']['comment']; ?></span></a></li>
...
?>
    <li><a href="<?php echo $this->_var['key']; ?>" target="main_frame"><?php echo $this->_var['item']; ?></a></li>
