...
<table width="99%" align="center" border="0" cellpadding="1" cellspacing="1" bgcolor="#ffffff">
  ...
  <tr>
    ...
    <?php echo $this->_var['lang']['complete_acquisition']; ?> 
      ...
      <font class="f4_b"><?php echo $this->_var['total']['will_get_integral']; ?></font>积分 <?php echo $this->_var['points_name']; ?>
      <?php endif; ?>
  ...
  <?php endif; ?>
  <tr>
    <td align="right" bgcolor="#ffffff"> <?php echo $this->_var['lang']['total_fee']; ?>： <font class="f4_b" style="font-size:18px;font-family:微软雅黑;"><?php echo $this->_var['total']['amount_formated']; ?></font>
