...
?>
    <ul class="clearfix bgcolor" <?php if (($this->_foreach['goods_list']['iteration'] - 1) % 2 == 0): ?>id=""<?php else: ?>id="bgcolor"<?php endif; ?>>
    	<li class="thumb">
		<a href="<?php echo $this->_var['goods']['url']; ?>"><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" class="pic_img_<?php echo $this->_var['goods']['goods_id']; ?>"/></a>
		</li>
    	<li class="goodsName">
    	...
    	<li class="action">
         	<?php if ($this->_var['goods']['goods_number'] == 0): ?><div class="shop_over" style="float:left">已售罄</div><?php endif; ?>
    		<a href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>);" class="abg">收藏</a>
    		<a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>);" nctype="add_cart" class="adc" <?php if ($this->_var['goods']['goods_number'] == 0): ?>style="background-color:#CCC; color:#EEE"<?php endif; ?>>加入购物车</a>
    	</li>
    </ul>
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    </div>
...
?> 
        ...
        <li class="item" <?php if ($this->_foreach['name']['iteration'] % 4 == 1): ?>style="margin-left:0px;"<?php endif; ?> id="li_<?php echo $this->_var['goods']['goods_id']; ?>">
		...
		<?php if ($this->_var['goods']['is_new'] == 1): ?><span class="little_pic">新品</span><?php endif; ?> 
            ...
            <div class="goods-pic" ><a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank"  title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"><img data-original="<?php echo $this->_var['goods']['goods_thumb']; ?>" src="themes/68ecshopcom_360buy/images/loading.gif" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" class="pic_img_<?php echo $this->_var['goods']['goods_id']; ?>"></a> </div>
		<?php if ($this->_var['goods']['goods_number'] == 0): ?><a href="<?php echo $this->_var['goods']['url']; ?>" class="shop_over1"></a><?php endif; ?>
            <div class="goods-info"> 
              <div class="goods-name"><a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"><?php echo htmlspecialchars($this->_var['goods']['name']); ?><em></em></a></div>
              <div class="goods-price"> <em class="sale-price" title="本店价：<?php if ($this->_var['goods']['promote_price'] != ""): ?><?php echo $this->_var['goods']['promote_price']; ?><?php else: ?><?php echo $this->_var['goods']['shop_price']; ?><?php endif; ?>"><?php if ($this->_var['goods']['promote_price'] != ""): ?><?php echo $this->_var['goods']['promote_price']; ?><?php else: ?><?php echo $this->_var['goods']['shop_price']; ?><?php endif; ?></em> <em class="market-price" title=""><?php echo $this->_var['goods']['market_price']; ?></em></div>
              <div class="sell-stat">
                <ul>
              ...
              <div class="store"> 
              	...
              	<a class="compare-btn shop-compare" data-goods="<?php echo $this->_var['goods']['goods_id']; ?>" data-type="<?php echo $this->_var['goods']['type']; ?>" onclick="Compare.add(<?php echo $this->_var['goods']['goods_id']; ?>,'<?php echo htmlspecialchars($this->_var['goods']['name']); ?>','<?php echo $this->_var['goods']['type']; ?>', '<?php echo $this->_var['goods']['goods_thumb']; ?>', '<?php echo $this->_var['goods']['shop_price']; ?>')"></a> </div>
              <div class="add-cart"> <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>);"><i class="icon-shopping-cart"></i>加入购物车</a> </div>
            </div>
          </div>
        </li>
        <?php endif; ?> 
