...
<div class="xm-pagenavi">
    ...
    <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_57300000_1527131520');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_57300000_1527131520']):
?>
      <?php if ($this->_var['key'] == 'keywords'): ?>
          <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo urldecode($this->_var['item_0_57300000_1527131520']); ?>" />
        <?php else: ?>
          <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_57300000_1527131520']; ?>" />
      <?php endif; ?>
...
<?php else: ?>
 ...
 <div class="xm-pagenavi">
    ...
    <?php if ($this->_var['pager']['page_prev']): ?><a class="numbers first iconfont" href="<?php echo $this->_var['pager']['page_prev']; ?>">&lt;</a><?php endif; ?>
     ...
     <?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_57300000_1527131520');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_57300000_1527131520']):
?>
      <?php if ($this->_var['pager']['page'] == $this->_var['key']): ?>
      <span class="numbers current"><?php echo $this->_var['key']; ?></span>
      <?php else: ?>
      <a class="numbers" href="<?php echo $this->_var['item_0_57300000_1527131520']; ?>"><?php echo $this->_var['key']; ?></a>
      <?php endif; ?>
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
  <?php endif; ?>
