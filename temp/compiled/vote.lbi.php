...
?>
    ...
    foreach ($_from AS $this->_var['title']):
?>
          <?php $_from = $this->_var['title']['options']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item_0_70800000_1527132053');if (count($_from)):
    foreach ($_from AS $this->_var['item_0_70800000_1527132053']):
?>
            <?php if ($this->_var['title']['can_multi'] == 0): ?>
            <p><input type="checkbox" name="option_id" value="<?php echo $this->_var['item_0_70800000_1527132053']['option_id']; ?>" />
            <?php echo $this->_var['item_0_70800000_1527132053']['option_name']; ?> (<?php echo $this->_var['item_0_70800000_1527132053']['percent']; ?>%)</p>
            <?php else: ?>
            <p><input type="radio" name="option_id" value="<?php echo $this->_var['item_0_70800000_1527132053']['option_id']; ?>" />
            <?php echo $this->_var['item_0_70800000_1527132053']['option_name']; ?> (<?php echo $this->_var['item_0_70800000_1527132053']['percent']; ?>%)</p>
            <?php endif; ?>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
