...
<body>
	<div id="site-nav">
		...
		<?php $_from = $this->_var['row']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'row_0_31047300_1487564078');if (count($_from)):
    foreach ($_from AS $this->_var['row_0_31047300_1487564078']):
?>
		<?php if ($this->_var['row_0_31047300_1487564078']['send_start_date'] < $this->_var['time'] && $this->_var['row_0_31047300_1487564078']['send_end_date'] > $this->_var['time']): ?>
