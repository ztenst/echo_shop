<?php exit;?>a:3:{s:8:"template";a:11:{i:0;s:68:"D:/xamp/htdocs/echo_shop/themes/68ecshopcom_360buy/pre_sale_list.dwt";i:1;s:74:"D:/xamp/htdocs/echo_shop/themes/68ecshopcom_360buy/library/page_header.lbi";i:2;s:74:"D:/xamp/htdocs/echo_shop/themes/68ecshopcom_360buy/library/user_header.lbi";i:3;s:80:"D:/xamp/htdocs/echo_shop/themes/68ecshopcom_360buy/library/user_header_right.lbi";i:4;s:73:"D:/xamp/htdocs/echo_shop/themes/68ecshopcom_360buy/library/header_tan.lbi";i:5;s:71:"D:/xamp/htdocs/echo_shop/themes/68ecshopcom_360buy/library/head_nav.lbi";i:6;s:68:"D:/xamp/htdocs/echo_shop/themes/68ecshopcom_360buy/library/pages.lbi";i:7;s:67:"D:/xamp/htdocs/echo_shop/themes/68ecshopcom_360buy/library/help.lbi";i:8;s:74:"D:/xamp/htdocs/echo_shop/themes/68ecshopcom_360buy/library/page_footer.lbi";i:9;s:71:"D:/xamp/htdocs/echo_shop/themes/68ecshopcom_360buy/library/site_bar.lbi";i:10;s:72:"D:/xamp/htdocs/echo_shop/themes/68ecshopcom_360buy/library/vote_list.lbi";}s:7:"expires";i:1527135417;s:8:"maketime";i:1527131817;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<script type="text/javascript" src="js/jquery.json.js"></script><script type="text/javascript" src="js/transport.js"></script>  <script type="text/javascript" src="js/utils.js"></script><script type="text/javascript" src="js/common.js"></script><script type="text/javascript" src="js/jquery.countdown-2.5.3.min.js"></script></head>
<body>
	<div id="site-nav">
...
<div class="list" onmouseover="_show_(this,{'source':'JS_side_cat_textarea_8','target':'JS_side_cat_list_8'});" onmouseout="_hide_(this);">
  ...
  <li><a href="pre_sale.php"  class="nav current" title="预售" >预售</a></li>  
    ...
    $('#searchtype').val($(this).attr('num'));
		...
		<div class="wdiv">
			...
			<div class="w">
				<div class="l">
					<div class="pro">
																		<div class="product" id="shijian_0" onmouseover="this.className='product hover1'" onmouseout="this.className='product'" >
							<div class="pic" id="li_55">
								<a href="pre_sale.php?id=25" target="_blank"> <img title="嘉云糖 300g玻璃罐装 水果硬糖 喜糖 德国进口" alt="嘉云糖 300g玻璃罐装 水果硬糖 喜糖 德国进口" width=220 height=220 data-original="images/201507/thumb_img/55_thumb_G_1437520599834.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" class="pic_img_55"></a> 							</div>
							<div class="shijian" id="shijian1_0">
								<i></i> <span id="ps_label_55" style="text-align: center;" over="false">结束未处理</span> <span id="ps_cd_55" style="display: none;"></span>
							</div>
							<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
				   	   				 ...
				   	   				 function(n){ return n.toString()
				            					   	           	...
				            					   	           	var endDate = new Date(2016, 07-1, 27, 00, 00, 00);
				            					   	           	//if(55 == 62){
				   	           	...
				   	           	function countdown_callback(ts){
				   	    			...
				   	    			if(status == 0){
				   	    				...
				   	    				if(ts == "End"){
					   	    				...
					   	    				$("#ps_cd_55").html("");
					   	    				$("#ps_label_55").html("预售中");
					   	    				$("#ps_label_55").attr("over", true);
					   	    				status = 1;
					   	    				endDate = new Date(2016, 07-1, 27, 00, 00, 00);
							...
							<div class="title">
								<a title="嘉云糖 300g玻璃罐装 水果硬糖 喜糖 德国进口" href="pre_sale.php?id=25" target="_blank">嘉云糖 300g玻璃罐装 水果硬糖 喜糖 德国进口</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span>12.00</span><span class="yp">38.00</span>
								</div>
								<span class="valid_order">0人已购买</span>
							</div>
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_55" href="javascript:collect(55); re_collect(55)">收藏</a>
								</div>
								<div class="n-tg">
									<a title="立即抢购" href="pre_sale.php?id=25" target="_blank">立即抢购</a>
								</div>
							</div>
						</div>
						<script type="text/javascript">
			            $(function(){
			              $("#shijian_0").mouseenter(function(){
			            	  	var isover = $("#ps_label_55").attr("over");
			                	if(isover == "false")
			                	{
			                		$("#ps_cd_55").show();
			        				$("#shijian1_0").animate({width:'260px'}, "fast");
			                	}
			              });
			              $("#shijian_0").mouseleave(function(){
			              		$("#shijian1_0").animate({width:'100px'}, "fast", function(){
			            			$("#ps_cd_55").hide();
			              		});
			              });
			            });
			            </script>
																								<div class="product" id="shijian_1" onmouseover="this.className='product hover1'" onmouseout="this.className='product'" >
							<div class="pic" id="li_62">
								<a href="pre_sale.php?id=27" target="_blank"> <img title="澳大利亚 进口牛奶 德运（Devondale） 全脂牛奶 1L*10 整箱装" alt="澳大利亚 进口牛奶 德运（Devondale） 全脂牛奶 1L*10 整箱装" width=220 height=220 data-original="images/201507/thumb_img/62_thumb_G_1437521071878.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" class="pic_img_62"></a> 							</div>
							<div class="shijian" id="shijian1_1">
								<i></i> <span id="ps_label_62" style="text-align: center;" over="false">结束未处理</span> <span id="ps_cd_62" style="display: none;"></span>
							</div>
							<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
				   	           	...
				   	           	function countdown_callback(ts){
				   	    			...
				   	    			if(status == 0){
				   	    				...
				   	    				if(ts == "End"){
					   	    				window.clearInterval(timerId);
					   	    				$("#ps_cd_62").html("");
					   	    				$("#ps_label_62").html("预售中");
					   	    				$("#ps_label_62").attr("over", true);
					   	    				status = 1;
					   	    				endDate = new Date(2016, 07-1, 27, 00, 00, 00);
					   	    				timerId = countdown(countdown_callback, endDate, countdown.DAYS | countdown.HOURS | countdown.MINUTES | countdown.SECONDS);
					   	    			}
							...
							<div class="title">
								<a title="澳大利亚 进口牛奶 德运（Devondale） 全脂牛奶 1L*10 整箱装" href="pre_sale.php?id=27" target="_blank">澳大利亚 进口牛奶 德运（Devondale） 全脂牛奶 1L*10 整箱装</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span>48.00</span><span class="yp">99.00</span>
								</div>
								<span class="valid_order">0人已购买</span>
							</div>
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_62" href="javascript:collect(62); re_collect(62)">收藏</a>
								</div>
								<div class="n-tg">
									<a title="立即抢购" href="pre_sale.php?id=27" target="_blank">立即抢购</a>
								</div>
							</div>
						</div>
						<script type="text/javascript">
			            $(function(){
			              $("#shijian_1").mouseenter(function(){
			            	  	var isover = $("#ps_label_62").attr("over");
			                	if(isover == "false")
			                	{
			                		$("#ps_cd_62").show();
			        				$("#shijian1_1").animate({width:'260px'}, "fast");
			                	}
			              });
			              $("#shijian_1").mouseleave(function(){
			              		$("#shijian1_1").animate({width:'100px'}, "fast", function(){
			            			$("#ps_cd_62").hide();
			              		});
			              });
			            });
			            </script>
																								<div class="product" id="shijian_2" onmouseover="this.className='product hover1'" onmouseout="this.className='product'" >
							<div class="pic" id="li_67">
								<a href="pre_sale.php?id=28" target="_blank"> <img title="一米画纱桑蚕丝吊带睡裙女夏季纯色真丝睡衣 " alt="一米画纱桑蚕丝吊带睡裙女夏季纯色真丝睡衣 " width=220 height=220 data-original="images/201507/thumb_img/67_thumb_G_1437521471001.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" class="pic_img_67"></a> 							</div>
							<div class="shijian" id="shijian1_2">
								<i></i> <span id="ps_label_67" style="text-align: center;" over="false">结束未处理</span> <span id="ps_cd_67" style="display: none;"></span>
							</div>
							<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
							...
							<div class="title">
								<a title="一米画纱桑蚕丝吊带睡裙女夏季纯色真丝睡衣 " href="pre_sale.php?id=28" target="_blank">一米画纱桑蚕丝吊带睡裙女夏季纯色真丝睡衣 </a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span>88.00</span><span class="yp">199.00</span>
								</div>
								<span class="valid_order">0人已购买</span>
							</div>
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_67" href="javascript:collect(67); re_collect(67)">收藏</a>
								</div>
								<div class="n-tg">
									<a title="立即抢购" href="pre_sale.php?id=28" target="_blank">立即抢购</a>
								</div>
							</div>
						</div>
						<script type="text/javascript">
			            $(function(){
			              $("#shijian_2").mouseenter(function(){
			            	  	var isover = $("#ps_label_67").attr("over");
			                	if(isover == "false")
			                	{
			                		$("#ps_cd_67").show();
			        				$("#shijian1_2").animate({width:'260px'}, "fast");
			                	}
			              });
			              $("#shijian_2").mouseleave(function(){
			              		$("#shijian1_2").animate({width:'100px'}, "fast", function(){
			            			$("#ps_cd_67").hide();
			              		});
			              });
			            });
			            </script>
																								<div class="product" id="shijian_3" onmouseover="this.className='product hover1'" onmouseout="this.className='product'" style="margin-right: 0px;">
							<div class="pic" id="li_50">
								<a href="pre_sale.php?id=31" target="_blank"> <img title="坚果炒货零食特产扁桃仁235gx2袋" alt="坚果炒货零食特产扁桃仁235gx2袋" width=220 height=220 data-original="images/201507/thumb_img/50_thumb_G_1437520471871.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" class="pic_img_50"></a> 							</div>
							<div class="shijian" id="shijian1_3">
								<i></i> <span id="ps_label_50" style="text-align: center;" over="false">结束未处理</span> <span id="ps_cd_50" style="display: none;"></span>
							</div>
							<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
				   	   				 ...
				   	   				 function(n){ return n.toString()
				            					   	           	...
				            					   	           	var endDate = new Date(2015, 07-1, 27, 00, 00, 00);
				            					   	           	//if(50 == 62){
				   	           	//	endDate = new Date(2015, 6, 29, 12, 09);
				   	           	//}
				   	           	...
				   	           	function countdown_callback(ts){
				   	    			...
				   	    			if(status == 0){
				   	    				...
				   	    				if(ts == "End"){
					   	    				window.clearInterval(timerId);
					   	    				$("#ps_cd_50").html("");
					   	    				$("#ps_label_50").html("预售中");
					   	    				$("#ps_label_50").attr("over", true);
					   	    				status = 1;
					   	    				endDate = new Date(2015, 07-1, 27, 00, 00, 00);
					   	    				timerId = countdown(countdown_callback, endDate, countdown.DAYS | countdown.HOURS | countdown.MINUTES | countdown.SECONDS);
					   	    			}
				   	    			}else{
				   	    				//预售中->活动已结束
							...
							<div class="title">
								<a title="坚果炒货零食特产扁桃仁235gx2袋" href="pre_sale.php?id=31" target="_blank">坚果炒货零食特产扁桃仁235gx2袋</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span>55.00</span><span class="yp">52.90</span>
								</div>
								<span class="valid_order">0人已购买</span>
							</div>
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_50" href="javascript:collect(50); re_collect(50)">收藏</a>
								</div>
								<div class="n-tg">
									<a title="立即抢购" href="pre_sale.php?id=31" target="_blank">立即抢购</a>
								</div>
							</div>
						</div>
						<script type="text/javascript">
			            $(function(){
			              $("#shijian_3").mouseenter(function(){
			            	  	var isover = $("#ps_label_50").attr("over");
			                	if(isover == "false")
			                	{
			                		$("#ps_cd_50").show();
			        				$("#shijian1_3").animate({width:'260px'}, "fast");
			                	}
			              });
			              $("#shijian_3").mouseleave(function(){
			              		$("#shijian1_3").animate({width:'100px'}, "fast", function(){
			            			$("#ps_cd_50").hide();
			              		});
			              });
			            });
...
<form name="selectPageForm" action="/pre_sale.php" method="get">
 <div id="pager">
